...
def conv3x1(in_planes, out_planes, stride=1, bias=True, dilation=1, init_scale=1.):
  """Convolution with 3x1 kernel

  Args:
      in_planes ()
      out_planes (_type_): _description_
      stride (int, optional): _description_. Defaults to 1.
      bias (bool, optional): _description_. Defaults to True.
      dilation (int, optional): _description_. Defaults to 1.
      init_scale (_type_, optional): _description_. Defaults to 1..
  ...
  conv = nn.Conv2d(in_planes, out_planes,
                    kernel_size=(3,1),
                    stride=stride,
                    padding=(1,0),   # on pad d'un pixel verticalement, 0 horizontalement
                    dilation=dilation,
                    bias=bias)
  conv.weight.data = default_init(init_scale)(conv.weight.data.shape)
  nn.init.zeros_(conv.bias)
